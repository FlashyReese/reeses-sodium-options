...
public final class OptionResetButtonRenderer {
    ...
    public static void render(GuiGraphicsExtractor guiGraphics, Dim2i controlDim, StatefulOption<?> option, int mouseX, int mouseY, boolean focused, boolean undoButtonVisible) {
        if (!isActive(option)) {
            return;
        }
