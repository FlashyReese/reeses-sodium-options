...
final class TabRail {
    ...
    void extractScrollBar(GuiGraphicsExtractor guiGraphics, int mouseX, int mouseY, float delta) {
        if (this.canScroll) {
            this.scrollBar.extractRenderState(guiGraphics, mouseX, mouseY, delta);
        }
    }
