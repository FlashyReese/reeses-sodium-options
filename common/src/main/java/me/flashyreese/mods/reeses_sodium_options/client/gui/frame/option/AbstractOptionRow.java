...
abstract class AbstractOptionRow extends BaseWidget implements ContainerEventHandler, OptionRow, ControlGuideProvider {
    ...
    public final boolean mouseClicked(double mouseX, double mouseY, int button) {
        return this.actionButtons.mouseClicked(mouseX, mouseY, button)
                || this.controlMouseClicked(mouseX, mouseY, button);
    }

    @Override
    public final boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        return this.actionButtons.keyPressedFocusedChild(keyCode, scanCode, modifiers)
                || this.controlKeyPressed(keyCode, scanCode, modifiers);
    }
