...
public final class OptionUndoButtonRenderer {
    ...
    public static void render(GuiGraphics guiGraphics, Dim2i controlDim, StatefulOption<?> option, int mouseX, int mouseY) {
        render(guiGraphics, controlDim, option, mouseX, mouseY, false);
    }

    public static void render(GuiGraphics guiGraphics, Dim2i controlDim, StatefulOption<?> option, int mouseX, int mouseY, boolean focused) {
        if (!isActive(option)) {
            return;
        }
