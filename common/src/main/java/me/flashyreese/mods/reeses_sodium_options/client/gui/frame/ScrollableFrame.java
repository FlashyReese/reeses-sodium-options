...
public class ScrollableFrame extends AbstractFrame {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        return super.mouseClicked(mouseX, mouseY, button) || (this.scrollLayout.canScrollHorizontal() && this.horizontalScrollBar.mouseClicked(mouseX, mouseY, button)) || (this.scrollLayout.canScrollVertical() && this.verticalScrollBar.mouseClicked(mouseX, mouseY, button));
    }

    @Override
    public boolean mouseDragged(double mouseX, double mouseY, int button, double deltaX, double deltaY) {
        return super.mouseDragged(mouseX, mouseY, button, deltaX, deltaY) || (this.scrollLayout.canScrollHorizontal() && this.horizontalScrollBar.mouseDragged(mouseX, mouseY, button, deltaX, deltaY)) || (this.scrollLayout.canScrollVertical() && this.verticalScrollBar.mouseDragged(mouseX, mouseY, button, deltaX, deltaY));
    }

    @Override
    public boolean mouseReleased(double mouseX, double mouseY, int button) {
        return super.mouseReleased(mouseX, mouseY, button) || (this.scrollLayout.canScrollHorizontal() && this.horizontalScrollBar.mouseReleased(mouseX, mouseY, button)) || (this.scrollLayout.canScrollVertical() && this.verticalScrollBar.mouseReleased(mouseX, mouseY, button));
    }
